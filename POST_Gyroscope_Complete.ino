...
// here in the code and must be a whole number
   gyX = Gyro::readX()+30  /* + INSERT INITIALIZATION VALUE HERE */ ;
   gyY = Gyro::readY()+17 /* + INSERT INITIALIZATION VALUE HERE */ ;
   gyZ = Gyro::readZ() -11/* + INSERT INITIALIZATION VALUE HERE */ ;
